...
<%
    ...
    String isambolana="SELECT MONTH(daty) AS volana, YEAR(daty) AS taona,SUM(maribola) AS totalmiditraparMoi FROM volamiditra GROUP BY MONTH(daty) and YEAR(daty)";
    String isataona="SELECT YEAR(daty) AS taona,SUM(maribola) AS totalmiditraparAns FROM volamiditra GROUP BY YEAR(daty)";
